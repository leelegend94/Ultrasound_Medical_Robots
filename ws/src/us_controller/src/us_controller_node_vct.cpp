...
void USController::init_pos(void){
    ...
    nh_.param<std::vector<double>>("/init_pose", init_pose, {6, 0.1, 0, 0, 1, 0, 0});
...
void USController::plan(const image_segmentation::EllipseConstPtr& msg){
    ...
    command.pose.position.z = curr_pose.position.z + marching[2];
